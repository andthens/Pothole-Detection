...
"")
        ...
        self.pix.setPixmap(QPixmap(u"img/voyage.png"))
    ...
    def retranslateUi(self, SplashScreen):
        SplashScreen.setWindowTitle(QCoreApplication.translate("SplashScreen", u"Pothole Detection", None))
        self.label_title.setText(QCoreApplication.translate("SplashScreen", u"<html><head/><body><p align=\"center\">POTHOLE DETECTION</p></body></html>", None))
